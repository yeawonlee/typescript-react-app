...
const Playground = () => {
  ...
  return (
    <section>
      <h1>Playground</h1>
      <div>Each of the following examples demonstrates one feature of the Autocomplete component.</div>

      <Stack spacing={1} sx={{ width: 300 }}>
        <Autocomplete
          {...defaultProps} // Spread 연산자: 배열 복제
          ...
          */
          renderInput={(param) => <TextField {...param} label="disableCloseOnSelect" variant="standard" />}
        />
